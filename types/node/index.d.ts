...
declare namespace NodeJS {
    ...
    // NOTE: moved to global augmentation in "events"
    export interface EventEmitter { }

    // NOTE: moved to global augmentation in "stream"
    export interface ReadableStream { }
    export interface WritableStream { }
    export interface ReadWriteStream { }

    // NOTE: moved to global augmentation in "domain"
    ...
    export interface Process extends EventEmitter {
        // NOTE: moved to global augmentation in "tty"
        // stdout: WriteStream;
        // stderr: WriteStream;
        // stdin: ReadStream;
        // openStdin(): Socket;
...
declare module "events" {
    ...
    namespace EventEmitter {
        export import EventEmitter = events;
    }
...
declare module "http" {
    ...
    export class IncomingMessage extends stream.Readable<string | Buffer> {
...
declare module "child_process" {
    ...
    export interface ChildProcess extends events.EventEmitter {
        stdin: stream.Writable<string | Buffer>;
        stdout: stream.Readable<string | Buffer>;
        stderr: stream.Readable<string | Buffer>;
        stdio: [stream.Writable<string | Buffer>, stream.Readable<string | Buffer>, stream.Readable<string | Buffer>];
        killed: boolean;
        pid: number;
        kill(signal?: string): void;
...
declare module "net" {
    ...
    export class Socket extends stream.Duplex {
        ...
        end(data?: any, encoding?: string): this;
...
declare module "fs" {
    ...
    export class ReadStream extends stream.Readable<string | Buffer> {
        close(): void;
        destroy(error?: Error | null): this;
        bytesRead: number;
        path: string | Buffer;
...
declare module "stream" {
    ...
    class Stream<T = any> extends events.EventEmitter {
        pipe<TDest extends NodeJS.WritableStream<T>>(destination: TDest, options?: { end?: boolean; }): TDest;
    }
    ...
    namespace Stream {
        ...
        export class Readable<T = any> extends Stream<T> implements NodeJS.ReadableStream<T> {
            ...
            resume(): this;
            isPaused(): boolean;
            unpipe<TDest extends NodeJS.WritableStream<T>>(destination?: TDest): this;
            unshift(chunk: T): void;
            wrap(oldStream: NodeJS.ReadableStream<T>): this;
            push(chunk: T | null, encoding?: string): boolean;
            /*protected*/ _destroy(err: Error | null, callback: (error?: Error | null) => void): void;
            destroy(error?: Error | null): this;
        ...
        export interface WritableOptions<T = any> {
            ...
            objectMode?: boolean;
            write?(this: Writable<T>, chunk: T, encoding: string, callback: (err?: Error | null) => void): void;
            writev?(this: Writable<T>, chunks: Array<{ chunk: T, encoding: string }>, callback: (err?: Error | null) => void): void;
            destroy?(this: Writable<T>, error: Error | null, callback: (error?: Error | null) => void): void;
            final?(this: Writable<T>, callback: (error?: (err?: Error | null) => void) => void): void;
        }
        ...
        export class Writable<T = any> extends Stream<T> implements NodeJS.WritableStream<T> {
            ...
            /*protected*/ _write(chunk: T, encoding: string, callback: (err?: Error | null) => void): void;
            /*protected*/ _writev?(chunks: Array<{ chunk: T, encoding: string }>, callback: (err?: Error | null) => void): void;
            /*protected*/ _destroy(err: Error | null, callback: (err?: Error | null) => void): void;
            /*protected*/ _final(callback: (err?: Error | null) => void): void;
            write(chunk: T, cb?: (err?: Error | null) => void): boolean;
            write(chunk: T, encoding?: string, cb?: (err?: Error | null) => void): boolean;
            setDefaultEncoding(encoding: string): this;
            end(cb?: (error?: Error) => void): this;
            end(chunk: T, cb?: (error?: Error) => void): this;
            end(chunk: T, encoding?: string, cb?: (error?: Error) => void): this;
            cork(): void;
            uncork(): void;
            destroy(error?: Error | null): this;
        ...
        export interface DuplexOptions<TRead = any, TWrite = TRead> extends ReadableOptions<TRead>, WritableOptions<TWrite> {
            allowHalfOpen?: boolean;
            readableObjectMode?: boolean;
            writableObjectMode?: boolean;
            read?(this: Duplex<TRead, TWrite>, size: number): void;
            write?(this: Duplex<TRead, TWrite>, chunk: TWrite, encoding: string, callback: (err?: Error | null) => void): void;
            writev?(this: Duplex<TRead, TWrite>, chunks: Array<{ chunk: TWrite, encoding: string }>, callback: (err?: Error | null) => void): void;
            destroy?(this: Duplex<TRead, TWrite>, error: Error | null, callback: (error?: Error | null) => void): void;
            final?(this: Duplex<TRead, TWrite>, callback: (error?: (err?: Error | null) => void) => void): void;
        }

        // Note: Duplex extends both Readable and Writable.
        export class Duplex<TRead = any, TWrite = TRead> extends Readable<TRead> implements Writable<TWrite> {
            writable: boolean;
            readonly writableHighWaterMark: number;
            readonly writableLength: number;
            constructor(opts?: DuplexOptions<TRead, TWrite>);
            /*protected*/ _write(chunk: TWrite, encoding: string, callback: (err?: Error | null) => void): void;
            /*protected*/ _writev?(chunks: Array<{ chunk: TWrite, encoding: string }>, callback: (err?: Error | null) => void): void;
            /*protected*/ _destroy(err: Error | null, callback: (err?: Error | null) => void): void;
            /*protected*/ _final(callback: (err?: Error | null) => void): void;
            write(chunk: TWrite, cb?: (error?: Error | null) => void): boolean;
            write(chunk: TWrite, encoding?: string, cb?: (error?: Error | null) => void): boolean;
            setDefaultEncoding(encoding: string): this;
            end(cb?: (error?: Error | null) => void): this;
            end(chunk: TWrite, cb?: (error?: Error | null) => void): this;
            end(chunk: TWrite, encoding?: string, cb?: (error?: Error | null) => void): this;
            cork(): void;
            uncork(): void;
        }

        export type TransformCallback<T = any> = (err?: Error | null, data?: T) => void;

        export interface TransformOptions<TRead = any, TWrite = TRead> extends DuplexOptions<TRead, TWrite> {
            transform?(this: Transform<TRead, TWrite>, chunk: TRead, encoding: string, callback: TransformCallback<TWrite>): void;
            flush?(this: Transform<TRead, TWrite>, callback: TransformCallback<TWrite>): void;
        }

        export class Transform<TRead = any, TWrite = TRead> extends Duplex<TRead, TWrite> {
            constructor(opts?: TransformOptions<TRead, TWrite>);
            /*protected*/ _transform(chunk: TRead, encoding: string, callback: TransformCallback<TWrite>): void;
            /*protected*/ _flush?(callback: TransformCallback<TWrite>): void;
            destroy(error?: Error | null): this;
        }

        export class PassThrough<TRead = any, TWrite = TRead> extends Transform<TRead, TWrite> { }

        export function finished(stream: NodeJS.ReadableStream | NodeJS.WritableStream, callback: (err?: Error) => void): void;

        export namespace finished {
            export function __promisify__(stream: NodeJS.ReadStream | NodeJS.WritableStream): Promise<void>;
        }

        export function pipeline<T1, TDest extends NodeJS.WritableStream<T1>>(stream1: NodeJS.ReadableStream<T1>, stream2: TDest, callback?: (err: NodeJS.ErrnoException) => void): TDest;
        export function pipeline<T1, T2, TDest extends NodeJS.WritableStream<T2>>(stream1: NodeJS.ReadableStream<T1>, stream2: NodeJS.ReadWriteStream<T1, T2>, stream3: TDest, callback?: (err: NodeJS.ErrnoException) => void): TDest;
        export function pipeline<T1, T2, T3, TDest extends NodeJS.WritableStream<T3>>(stream1: NodeJS.ReadableStream<T1>, stream2: NodeJS.ReadWriteStream<T1, T2>, stream3: NodeJS.ReadWriteStream<T2, T3>, stream4: TDest, callback?: (err: NodeJS.ErrnoException) => void): TDest;
        export function pipeline<T1, T2, T3, T4, TDest extends NodeJS.WritableStream<T4>>(stream1: NodeJS.ReadableStream<T1>, stream2: NodeJS.ReadWriteStream<T1, T2>, stream3: NodeJS.ReadWriteStream<T2, T3>, stream4: NodeJS.ReadWriteStream<T3, T4>, stream5: TDest, callback?: (err: NodeJS.ErrnoException) => void): TDest;
        ...
        export namespace pipeline {
            export function __promisify__<T1, TDest extends NodeJS.WritableStream<T1>>(stream1: NodeJS.ReadableStream<T1>, stream2: TDest): Promise<void>;
            export function __promisify__<T1, T2, TDest extends NodeJS.WritableStream<T2>>(stream1: NodeJS.ReadableStream<T1>, stream2: NodeJS.ReadWriteStream<T1, T2>, stream3: TDest): Promise<void>;
            export function __promisify__<T1, T2, T3, TDest extends NodeJS.WritableStream<T3>>(stream1: NodeJS.ReadableStream<T1>, stream2: NodeJS.ReadWriteStream<T1, T2>, stream3: NodeJS.ReadWriteStream<T2, T3>, stream4: TDest): Promise<void>;
            export function __promisify__<T1, T2, T3, T4, TDest extends NodeJS.WritableStream<T4>>(stream1: NodeJS.ReadableStream<T1>, stream2: NodeJS.ReadWriteStream<T1, T2>, stream3: NodeJS.ReadWriteStream<T2, T3>, stream4: NodeJS.ReadWriteStream<T3, T4>, stream5: TDest): Promise<void>;
    ...
    global {
        namespace NodeJS {
            interface ReadableStream<T = string | Buffer> extends EventEmitter {
                readable: boolean;
                read(size?: number): T;
                setEncoding(encoding: string): this;
                pause(): this;
                resume(): this;
                isPaused(): boolean;
                pipe<TDest extends WritableStream<T>>(destination: TDest, options?: { end?: boolean; }): TDest;
                unpipe<TDest extends WritableStream<T>>(destination?: TDest): this;
                unshift(chunk: T): void;
                wrap(oldStream: ReadableStream<T>): this;
                [Symbol.asyncIterator](): AsyncIterableIterator<T>;
            }

            interface WritableStream<T = string | Buffer> extends EventEmitter {
                writable: boolean;
                write(chunk: T, cb?: (error?: Error | null) => void): boolean;
                write(chunk: T, encoding?: string, cb?: (error?: Error | null) => void): boolean;
                end(cb?: (error?: Error | null) => void): this;
                end(chunk: T, cb?: (error?: Error | null) => void): this;
                end(chunk: T, encoding?: string, cb?: (error?: Error | null) => void): this;
            }

            interface ReadWriteStream<TRead = string | Buffer, TWrite = TRead> extends ReadableStream<TRead>, WritableStream<TWrite> {
            }
        }
    }
...
declare module "tty" {
    ...
    global {
        namespace NodeJS {
            /** @deprecated Use `ReadStream` in "tty" */
            interface ReadStream extends _tty.ReadStream { }

            /** @deprecated Use `ReadStream` in "tty" */
            interface WriteStream extends _tty.WriteStream { }

            interface Process {
                stdout: _tty.WriteStream;
                stderr: _tty.WriteStream;
                stdin: _tty.ReadStream;
                openStdin(): _tty.ReadStream;
            }
        }
    }
}
...
declare module "http2" {
    ...
    export interface Http2Stream extends stream.Duplex<string | Buffer> {
        ...
        addListener(event: "pipe", listener: (src: stream.Readable<string | Buffer>) => void): this;
        addListener(event: "unpipe", listener: (src: stream.Readable<string | Buffer>) => void): this;
        ...
        emit(event: "pipe", src: stream.Readable<string | Buffer>): boolean;
        emit(event: "unpipe", src: stream.Readable<string | Buffer>): boolean;
        ...
        on(event: "pipe", listener: (src: stream.Readable<string | Buffer>) => void): this;
        on(event: "unpipe", listener: (src: stream.Readable<string | Buffer>) => void): this;
        ...
        once(event: "pipe", listener: (src: stream.Readable<string | Buffer>) => void): this;
        once(event: "unpipe", listener: (src: stream.Readable<string | Buffer>) => void): this;
        ...
        prependListener(event: "pipe", listener: (src: stream.Readable<string | Buffer>) => void): this;
        prependListener(event: "unpipe", listener: (src: stream.Readable<string | Buffer>) => void): this;
        ...
        prependOnceListener(event: "pipe", listener: (src: stream.Readable<string | Buffer>) => void): this;
        prependOnceListener(event: "unpipe", listener: (src: stream.Readable<string | Buffer>) => void): this;
    ...
    export interface Http2ServerRequest extends stream.Readable<string | Buffer> {
        headers: IncomingHttpHeaders;
        httpVersion: string;
        method: string;
        rawHeaders: string[];
